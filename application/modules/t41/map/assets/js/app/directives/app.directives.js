...
+'					</li>'
+'					<li class="field">'
+'						<label class="fieldkey" for="{{key}}ext">extended output</label>'
+'						<input type="checkbox" class="" ng-model="api.ext" id="{{key}}ext" />'
+'					</li>'
+'					<li class="field">'
+'						<label class="fieldkey" for="{{key}}data">show data only</label>'
+'						<input type="checkbox" class="" ng-model="api.data" id="{{key}}data" />'
+'					</li>'
+'					<li class="field">'
